...
export default function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        alert(`Account creation initiated for Employee ID: ${employeeId} in ${district}, ${state}.`);
    };

    // Get districts for the selected state with error handling
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden" style={{ backgroundImage: `url(${platformbcg})`, backgroundSize: 'cover' }}>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 w-full max-w-md">
                    ...
                    <div onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            ...
                            {/* District Dropdown with improved error handling */}
                            <div>
                                <label className="block text-gray-300 text-sm font-medium mb-2">
                                    District
                                </label>
                                ...
                                >
                                    ...
                                    {/* Fixed district mapping with better error handling */}
